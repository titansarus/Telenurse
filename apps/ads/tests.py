...
def create_ad(
        ...
        address="Tehran",
        start_time=datetime(2030, 9, 16, tzinfo=pytz.UTC),
        end_time=datetime(2031, 9, 16, tzinfo=pytz.UTC),
        service_type="1",
        gender="M",
        accepted=False,
        urgency="0",
...
class AdTest(TestCase):
    def setUp(self) -> None:
        ...
        self.test_ad1 = create_ad(first_name="test1",
                                  ...
                                  address="Tehran",
                                  start_time=datetime(2030, 9, 16, tzinfo=pytz.UTC),
                                  end_time=datetime(2030, 9, 16, tzinfo=pytz.UTC),
                                  service_type="1",
                                  gender="M",
                                  accepted=False,
                                  urgency="0",
    ...
    def attempt_to_edit(self, credentials, ad_id):
        ...
        payload = {
            ...
            "start_time": datetime(2031, 9, 16, 10, 10, 10, 0, pytz.timezone("UTC")),
            "end_time": datetime(2031, 9, 17, 10, 10, 10, 0, pytz.timezone("UTC")),
            "service_type": "2",
            "gender": "W",
            "urgency": "0",
            "description": "description"
