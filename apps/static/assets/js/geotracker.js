...
function index_startup(username) {
    ...
    if (localStorage.getItem("watchId") == "1") {
        continue_tracking(username, localStorage.getItem("ad_id"));
    } else {
...
function continue_tracking(username, ad_id) {
    alert("continue tracking");
    ...
    localStorage.setItem("watchId", watchId);
    alert(localStorage.getItem("watchId") + " " + typeof localStorage.getItem("watchId") + " " + typeof watchId);
}
...
function stop_tracking(username, ad_id) {
    alert(localStorage.getItem("watchId") + " " + typeof localStorage.getItem("watchId"));
    if (localStorage.getItem("watchId") != "1") {
        ...
        if (localStorage.getItem("ad_id") != ad_id.toString()) {
            ...
            navigator.geolocation.clearWatch(parseInt(localStorage.getItem("watchId")));
            localStorage.setItem("watchId", "0");
            alert("set to " + localStorage.getItem("watchId"));
            let tracking_name = username;
